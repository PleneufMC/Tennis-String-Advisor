...
export const racquetsDatabase: TennisRacquet[] = [
  ...
  },
  {
    ...
    category: 'Power',
    playerLevel: ['Intermediate', 'Advanced'],
    description: 'Cadre puissance v5 (technologie SI3D). Version de base de la gamme Ultra : RA 67, beam 24mm. Tolérante et explosive.',
    proUsage: 'Alex de Minaur, Marta Kostyuk',
    price: { europe: 270, usa: 269 }
  },
  {
    id: 'wilson-ultra-100l-v5',
    brand: 'Wilson',
    model: 'Ultra',
    variant: '100L v5',
    stiffness: 67,
    ...
    category: 'Power',
    playerLevel: ['Intermediate'],
    description: 'Version allégée de l\'Ultra 100 v5 (280g). Maniable et puissante, idéale pour un swing rapide sans effort.',
    price: { europe: 240, usa: 249 }
  },
  {
    ...
    category: 'Power',
    playerLevel: ['Beginner', 'Intermediate'],
    description: 'Ultra-légère (260g) pour joueurs débutants à intermédiaires recherchant un maximum de maniabilité.',
    price: { europe: 220, usa: 229 }
  },
  {
    id: 'wilson-ultra-111-v5',
    brand: 'Wilson',
    model: 'Ultra',
    variant: '111 v5',
    stiffness: 65,
    ...
    category: 'Power',
    playerLevel: ['Beginner', 'Intermediate'],
    description: 'Modèle oversize (111 in²) et léger (270g) de la gamme Ultra v5. Tamis ultra-tolérant et longueur 27,25" pour un maximum de puissance et de confort sur les retours et coups décentrés.',
    price: { europe: 230, usa: 239 }
  },
  {
    id: 'wilson-ultra-99-pro-v5',
    brand: 'Wilson',
    model: 'Ultra',
    variant: '99 Pro v5',
    stiffness: 69,
    ...
    category: 'Modern Player',
    playerLevel: ['Advanced', 'Pro'],
    description: 'Version contrôle/joueur de la gamme Ultra v5 (moule Steam revisité) : tamis 99 in², plan 16x18, 305g, RA 69. Puissance contrôlable et sensations précises pour le compétiteur.',
    price: { europe: 280, usa: 279 }
  },
  {
    id: 'wilson-ultra-26-v5',
    brand: 'Wilson',
    model: 'Ultra',
    variant: '26" Junior',
    stiffness: null,
