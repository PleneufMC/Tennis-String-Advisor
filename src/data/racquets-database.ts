...
export const racquetsDatabase: TennisRacquet[] = [
  ...
  },
  {
    ...
    category: 'Power',
    playerLevel: ['Beginner', 'Intermediate'],
    description: 'Modèle Team v5 (270g, 4 pts HL). Excellent compromis puissance/contrôle pour la progression.',
    price: { europe: 200, usa: 199 }
  },
  {
    id: 'wilson-ultra-108-v5',
    brand: 'Wilson',
    model: 'Ultra',
    variant: '108 v5',
    stiffness: 70,
    ...
    category: 'Power',
    playerLevel: ['Beginner', 'Intermediate'],
    description: 'Grand tamis (108 in²) et léger : maximum de tolérance et de puissance pour les joueurs loisir.',
    price: { europe: 230, usa: 239 }
  },
  {
    id: 'wilson-ultra-pro-99-v5',
    brand: 'Wilson',
    model: 'Ultra',
    variant: 'Pro 99 v5',
    stiffness: 66,
    ...
    category: 'Modern Player',
    playerLevel: ['Advanced', 'Pro'],
    description: 'Version contrôle/joueur de la gamme Ultra : tamis 99 in², plan 16x18, 305g. Plus de précision et de sensations.',
