...
export const dictionaries = {
  fr: {
    ...
    'nav.myConfigurations': 'Mon journal de cordage',
    ...
    'footer.link.tmf': 'Trouver des partenaires de jeu',
    'footer.link.faq': 'FAQ',
  ...
  en: {
    ...
    'nav.myConfigurations': 'My stringing log',
    ...
    'footer.link.tmf': 'Find playing partners',
    'footer.link.faq': 'FAQ',
